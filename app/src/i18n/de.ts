...
export const de = {
  ...
  "create.chapter.description":
    'Der Titel wird zur id des Kapitels — sie steht in jeder Szenen-Adresse und bleibt, wie sie ist. Das Ziel ist optional und erscheint im Kapitel als Abschnitt „Ziel des Kapitels“.',
