...
// (scene aside) or, with `onOpen`, a BUTTON that hands the entry path back to
// the caller (live mode: a card click must open the detail drawer, never
// navigate away from the running session). Both are
