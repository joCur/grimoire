-- Issue #115 / ADR #18: `scenes.chapter_id` becomes a REAL foreign key.
--
...
CREATE TABLE `__new_scenes` (
	...
	`id` text NOT NULL,
	`chapter_id` text,
	`chapter_declared` integer DEFAULT 1 NOT NULL,
...
INSERT INTO `__new_scenes`("campaign_id", "id", "chapter_id", "chapter_declared", "title", "type", "trigger", "location", "status", "handouts", "body", "extra", "pos", "rev") SELECT "campaign_id", "id", "chapter_id", "chapter_declared", "title", "type", "trigger", "location", "status", "handouts", "body", "extra", "pos", "rev" FROM `scenes`;--> statement-breakpoint
